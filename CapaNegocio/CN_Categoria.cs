...
namespace CapaNegocio
{
    ...
    {
        private CD_Categoria objcd_Categoria = new CD_Categoria();  // Crea una instancia de la clase CD_Categoria para interactuar con la capa de datos.

        // Método que llama al método 'Listar' de la clase CD_Categoria y devuelve la lista de Categorias obtenida.
        public List<Categoria> Listar()
        {
            return objcd_Categoria.Listar();  // Llama al método 'Listar' de CD_Categoria y devuelve la lista de Categorias recuperada de la base de datos.
        }
